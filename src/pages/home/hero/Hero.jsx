      ...
      >
        {sliderItem.map((slider, index) => (
          <SwiperSlide key={index}>
            <>
              <div className={`flex sm:flex-row flex-col-reverse items-center gap-5 sm:gap-0 py-10 sm:py-0 sm:rounded-md max-w-[1400px] mx-auto`}>
                <div className="w-full sm:flex-1">
                  <div className="flex h-full justify-center items-center">
                    <div className="w-9/12 text-center sm:text-left">
                      <h2 className="text-3xl text-primary sm:text-5xl font-semibold mb-3">
                        {slider.title}
                      </h2>
                      <h3 className="sm:text-lg text-black text-base mb-5">
                        {slider.description}
                      </h3>
                ...
                <div className="w-full sm:flex-1">
                  <img className="sm:w-full w-[80%] mx-auto" src={slider.image} alt="" />
                </div>
              </div>
            </>
          </SwiperSlide>
