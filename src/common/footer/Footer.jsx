      ...
      <div className="bg-zinc-800 pt-20 pb-5">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-y-20 gap-x-10 max-w-[1400px] mx-auto px-5 md:px-10 lg:px-14">
          <div className="">
            ...
            <p className="text-[16px] text-white mt-2">contact@example.com</p>
            <p className="text-[16px] text-white mt-2">+880140000000</p>
          </div>
          <div>
            <h3 className="text-white text-sm sm:text-base mb-3">My Account</h3>
            <Link to="/login">
              <li className="list-none text-[16px] text-primary mb-3">Sign In</li>
            </Link>
            <Link to="/cart">
              <li className="list-none text-[16px] text-primary mb-3">
                View Cart
              </li>
            </Link>
            <Link to="wishlist">
            ...
            <li className="list-none text-[16px] text-primary mb-3">My Order</li>
            <li className="list-none text-[16px] text-primary mb-3">Help</li>
          </div>
          <div>
            ...
            <li className="list-none text-[16px] text-primary mb-3">Returns</li>
            <li className="list-none text-[16px] text-primary mb-3">Shipping</li>
            <li className="list-none text-[16px] text-primary mb-3">
          ...
          <div>
            ...
            <Link to="/contact">
              <li className="list-none text-[16px] text-primary mb-3">Contact</li>
            </Link>
          </div>
        </div>
        <hr className="mt-10" />
