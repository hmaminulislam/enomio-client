        ...
        <div className='offer-modal'>
            ...
            <div>
                ...
                <div className='flex justify-center h-10 items-center mt-4 w-[80%] mx-auto'>
                    <input placeholder='Email' className='w-[80%] h-full border-2 outline-none px-3 text-sm' type="text" />
                    <i class="fa-solid fa-magnifying-glass text-xl text-center flex-auto h-full bg-black text-white pt-2 cursor-pointer"></i>
                </div>
            </div>
