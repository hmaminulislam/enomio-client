        ...
        <div className='offer-modal'>
            ...
            <div>
                ...
                <div className='flex justify-center h-10 items-center mt-4 w-[80%] mx-auto'>
                    ...
                    <i className="fa-solid fa-magnifying-glass text-xl text-center flex-auto h-full bg-black text-white cursor-pointer offer-icon"></i>
                </div>
            </div>
            <i onClick={() => setModalOpen(false)} className="fa-solid fa-xmark text-2xl cursor-pointer absolute top-[5px] right-[10px]"></i>
        </div>
    );
};
